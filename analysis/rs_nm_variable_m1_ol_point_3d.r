...
val <- (d$m1Optimal/d$LowBound)  # value
job <- d$n         # x
proc<- d$m        # Y
...
#------------------------------------------------
name      <- paste("rr_",algo,"_",instType,"_",distType,"_","optimalDIVnatlowbound")
titleMain <- paste(algo," ",instType," ",distType," ","Optimal / (nat) Low bound")
ext       <- ".pdf"
